<h1 align="center">
      💠 Challenge 06 - Node.js Unit Tests
</h1>

<h3 align="center">
    🔥 Ingnite Node.js challenge - Unit Tests.
</h3>

<p align="center">
  <img alt="GitHub language count" src="https://img.shields.io/github/languages/count/henbalmant/challenge-06-node-unit-tests?color=%2304D361">

  <img alt="Repository size" src="https://img.shields.io/github/repo-size/henbalmant/challenge-06-node-unit-tests">

  <a href="https://github.com/henbalmant/delivery-app-node-js/commits/master">
    <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/henbalmant/challenge-06-node-unit-tests">
  </a>

   <img alt="License" src="https://img.shields.io/badge/license-MIT-brightgreen">
   <a href="https://github.com/henbalmant/delivery-app-node-js/stargazers">
    <img alt="Stargazers" src="https://img.shields.io/github/stars/henbalmant/challenge-06-node-unit-tests?style=social">
  </a>
...
$ git clone git@github.com:henbalmant/challenge-06-node-unit-tests.git

# Access the project folder with your terminal/cmd
$ cd challenge-06-node-unit-tests
...
> See [package.json](https://github.com/henbalmant/challenge-06-node-unit-tests/blob/main/package.json)
